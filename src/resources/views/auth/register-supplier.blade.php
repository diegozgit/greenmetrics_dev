...
@section('content')
    <div class="bg-light p-5 rounded text-center">
        ...
        <h1>Registra Fornitore</h1>
        <div class="d-flex justify-content-center flex-column align-items-center">
            <form method="post" action="{{ route('registerSupplier.perform') }}" class="col-md-6 mb-3">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Inserisci qua i tuoi dati del fornitore:</h6>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="partitaIva"
                                ...
                                value="{{ old('partitaIva') }}" placeholder="Partita IVA" required="required" autofocus>
                        ...
                        <div class="mb-3">
                            <label for="indirizzoInput" class="form-label">Via della sede legale*:
                            </label>
                        ...
                        <div class="mb-3">
                            <label for="civicoInput" class="form-label">Numero Civico della sede legale*:
                            </label>
                            <input type="text" name="civico" class="form-control @error('civico') is-invalid @enderror"
                                id="civicoInput" value="{{ old('civico') }}" placeholder="Numero civico" required="required"
                                autofocus>
                        ...
                        <div class="mb-3">
                            <label for="capInput" class="form-label">CAP della sede legale*: </label>
                        ...
                        <div class="mb-3">
                            <label for="comuneInput" class="form-label">Comune della sede legale*:
                            </label>
                        ...
                        <div class="mb-3">
                            <label for="provinciaInput" class="form-label">Provincia della sede legale*:
                            </label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                id="emailInput" value="{{ old('email') }}" placeholder="nome@gmail.com"
